 ...
 */
class EmailParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmailParams';
    ...
    */
     ...
     * Sets to
     *
     * @param string $to The email to send the alert to when it triggers
     *
     * @return self
     */
