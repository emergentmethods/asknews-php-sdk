...
/**
 * LegacyReportRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class LegacyReportRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LegacyReportRequest';
    ...
    public const IDENTIFIER_LEGACY = 'legacy';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('identifier', $data ?? [], 'legacy');
    ...
    */
    ...
    public function setLogoUrl($logo_url)
    {
        ...
        if (!is_null($logo_url) && (mb_strlen($logo_url) > 2083)) {
            throw new \InvalidArgumentException('invalid length for $logo_url when calling LegacyReportRequest., must be smaller than or equal to 2083.');
        }
        if (!is_null($logo_url) && (mb_strlen($logo_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $logo_url when calling LegacyReportRequest., must be bigger than or equal to 1.');
        }
