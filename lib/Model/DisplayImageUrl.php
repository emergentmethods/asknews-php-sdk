...
/**
 * DisplayImageUrl Class Doc Comment
 *
 * @category Class
 * @package  AskNews
 * @author   OpenAPI Generator team
 ...
 */
class DisplayImageUrl implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DisplayImageUrl';
    ...
    */
    ...
    public function setImageUrl($image_url)
    {
        ...
        if ((mb_strlen($image_url) > 2083)) {
            throw new \InvalidArgumentException('invalid length for $image_url when calling DisplayImageUrl., must be smaller than or equal to 2083.');
        }
        if ((mb_strlen($image_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $image_url when calling DisplayImageUrl., must be bigger than or equal to 1.');
        }
