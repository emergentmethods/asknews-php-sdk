...
/**
 * StoryUpdateDisplayImageUrlsInner Class Doc Comment
 *
 * @category Class
 * @package  AskNews
 * @author   OpenAPI Generator team
 ...
 */
class StoryUpdateDisplayImageUrlsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StoryUpdate_display_image_urls_inner';
    ...
    */
    ...
    public function setImageUrl($image_url)
    {
        ...
        if ((mb_strlen($image_url) > 2083)) {
            throw new \InvalidArgumentException('invalid length for $image_url when calling StoryUpdateDisplayImageUrlsInner., must be smaller than or equal to 2083.');
        }
        if ((mb_strlen($image_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $image_url when calling StoryUpdateDisplayImageUrlsInner., must be bigger than or equal to 1.');
        }
