...
class CreateAlertRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'active' => 'bool',
        'expires_at' => '\DateTime',
        'report' => '\AskNews\Model\CreateAlertRequestReport',
        'title' => 'string',
        'share_link' => 'string'
    ];
    ...
    public const ALERT_TYPE_ALWAYS_ALERT_WHEN = 'AlwaysAlertWhen';
    public const ALERT_TYPE_ALERT_ONCE_IF = 'AlertOnceIf';
    public const ALERT_TYPE_REPORT_ABOUT = 'ReportAbout';
    ...
    {
        return [
            self::ALERT_TYPE_ALWAYS_ALERT_WHEN,
            self::ALERT_TYPE_ALERT_ONCE_IF,
            self::ALERT_TYPE_REPORT_ABOUT,
        ];
    }
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('model', $data ?? [], 'gpt-4o');
    ...
    */
     ...
     * Sets query
     *
     * @param string $query The query to run for the alert.
     *
     * @return self
     */
     ...
     * Gets sources
     *
     * @return \AskNews\Model\SourcesInner[]
     */
     ...
     * Sets sources
     *
     * @param \AskNews\Model\SourcesInner[] $sources sources
     *
     * @return self
     */
    ...
    public function setAlertType($alert_type)
    {
        if (is_null($alert_type)) {
            array_push($this->openAPINullablesSetToNull, 'alert_type');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('alert_type', $nullablesSetToNull);
            if ($index !== FALSE) {
        ...
        $allowedValues = $this->getAlertTypeAllowableValues();
        if (!is_null($alert_type) && !in_array($alert_type, $allowedValues, true)) {
     ...
     * Sets model
     *
     * @param string|null $model The model that is used to check if the alert conditions are satisfied by sources (this is not the same as the model used to write the report.)Defaults to gpt-4o.
     *
     * @return self
     */
     ...
     * Sets cron
     *
     * @param string $cron How often or when to check sources for this alert, specified as a cron expression. Examples: '0 * * * *' (hourly), '0 9 * * *' (daily at 9am), '0 9 * * 1' (Mondays at 9am).  See https://crontab.run/ for more examples.
     *
     * @return self
     */
     ...
     * Sets always_trigger
     *
     * @param bool|null $always_trigger Whether to always trigger the actions when sources are scanned. This skips the check for if the alert conditions are satisfied and run triggers immediately. Defaults to False.
     *
     * @return self
     */
     ...
     * Gets report
     *
     * @return \AskNews\Model\CreateAlertRequestReport|null
     */
     ...
     * Sets report
     *
     * @param \AskNews\Model\CreateAlertRequestReport|null $report report
     *
     * @return self
     */
