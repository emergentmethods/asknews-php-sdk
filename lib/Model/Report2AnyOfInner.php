...
/**
 * Report2AnyOfInner Class Doc Comment
 *
 * @category Class
 * @package  AskNews
 * @author   OpenAPI Generator team
 ...
 */
class Report2AnyOfInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Report_2_anyOf_inner';
    ...
    public const MODEL_GPT_5_6_TERRA = 'gpt-5.6-terra';
    public const MODEL_GPT_5_6_SOL = 'gpt-5.6-sol';
    ...
    public function getModelAllowableValues()
    {
        return [
            ...
            self::MODEL_CLAUDE_FABLE_5,
            self::MODEL_CLAUDE_SONNET_4_6,
            self::MODEL_CLAUDE_SONNET_5,
            self::MODEL_CLAUDE_OPUS_4_8,
            self::MODEL_CLAUDE_OPUS_5,
            self::MODEL_GPT_5_6_TERRA,
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('model', $data ?? [], 'claude-sonnet-5');
    ...
    */
    ...
    public function setLogoUrl($logo_url)
    {
        ...
        if ((mb_strlen($logo_url) > 2083)) {
            throw new \InvalidArgumentException('invalid length for $logo_url when calling Report2AnyOfInner., must be smaller than or equal to 2083.');
        }
        if ((mb_strlen($logo_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $logo_url when calling Report2AnyOfInner., must be bigger than or equal to 1.');
        }
     ...
     * Sets model
     *
     * @param string|null $model The model to use for the report. Defaults to claude-sonnet-5.
     *
     * @return self
     */
