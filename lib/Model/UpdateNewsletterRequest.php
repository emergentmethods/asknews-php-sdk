...
/**
 * UpdateNewsletterRequest Class Doc Comment
 *
 * @category Class
 * @package  AskNews
 * @author   OpenAPI Generator team
 ...
 */
class UpdateNewsletterRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateNewsletterRequest';
    ...
    */
    ...
    public function setLogoUrl($logo_url)
    {
        ...
        if (!is_null($logo_url) && (mb_strlen($logo_url) > 2083)) {
            throw new \InvalidArgumentException('invalid length for $logo_url when calling UpdateNewsletterRequest., must be smaller than or equal to 2083.');
        }
        if (!is_null($logo_url) && (mb_strlen($logo_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $logo_url when calling UpdateNewsletterRequest., must be bigger than or equal to 1.');
        }
