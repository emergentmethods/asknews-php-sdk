...
/**
 * CreateAlertRequestReport Class Doc Comment
 *
 * @category Class
 * @package  AskNews
 * @author   OpenAPI Generator team
 ...
 */
class CreateAlertRequestReport implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateAlertRequest_report';
    ...
    */
    ...
    public function setLogoUrl($logo_url)
    {
        ...
        if ((mb_strlen($logo_url) > 2083)) {
            throw new \InvalidArgumentException('invalid length for $logo_url when calling CreateAlertRequestReport., must be smaller than or equal to 2083.');
        }
        if ((mb_strlen($logo_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $logo_url when calling CreateAlertRequestReport., must be bigger than or equal to 1.');
        }
