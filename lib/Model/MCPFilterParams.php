...
/**
 * MCPFilterParams Class Doc Comment
 *
 * @category Class
 * @package  AskNews
 * @author   OpenAPI Generator team
 ...
 */
class MCPFilterParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MCPFilterParams';
    ...
    */
    ...
    public function setStartTimestamp($start_timestamp)
    {
        if (is_null($start_timestamp)) {
            array_push($this->openAPINullablesSetToNull, 'start_timestamp');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('start_timestamp', $nullablesSetToNull);
            if ($index !== FALSE) {
    ...
    public function setEndTimestamp($end_timestamp)
    {
        if (is_null($end_timestamp)) {
            array_push($this->openAPINullablesSetToNull, 'end_timestamp');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('end_timestamp', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Gets offset
     *
     * @return \AskNews\Model\Offset4|null
     */
     ...
     * Sets offset
     *
     * @param \AskNews\Model\Offset4|null $offset offset
     *
     * @return self
     */
    ...
    public function setReverseEntityGuarantee($reverse_entity_guarantee)
    {
        if (is_null($reverse_entity_guarantee)) {
            array_push($this->openAPINullablesSetToNull, 'reverse_entity_guarantee');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('reverse_entity_guarantee', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
