...
class ReportRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets model
     *
     * @param string|null $model The model to use for the report. Defaults to claude-sonnet-4-5-20250929. If you have DeepNews as a source, the DeepNews model will be used for the report.
     *
     * @return self
     */
