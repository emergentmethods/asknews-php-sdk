...
/**
 * AnthropicToolUseBlock1 Class Doc Comment
 *
 * @category Class
 * @package  AskNews
 * @author   OpenAPI Generator team
 ...
 */
class AnthropicToolUseBlock1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AnthropicToolUseBlock_1';
    ...
    {
        $this->setIfExists('type', $data ?? [], 'tool_use');
