...
/**
 * Report1AnyOf Class Doc Comment
 *
 * @category Class
 * @package  AskNews
 * @author   OpenAPI Generator team
 ...
 */
class Report1AnyOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Report_1_anyOf';
    ...
    */
    ...
    public function setLogoUrl($logo_url)
    {
        ...
        if ((mb_strlen($logo_url) > 2083)) {
            throw new \InvalidArgumentException('invalid length for $logo_url when calling Report1AnyOf., must be smaller than or equal to 2083.');
        }
        if ((mb_strlen($logo_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $logo_url when calling Report1AnyOf., must be bigger than or equal to 1.');
        }
