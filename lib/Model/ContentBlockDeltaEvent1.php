...
/**
 * ContentBlockDeltaEvent1 Class Doc Comment
 *
 * @category Class
 * @package  AskNews
 * @author   OpenAPI Generator team
 ...
 */
class ContentBlockDeltaEvent1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContentBlockDeltaEvent_1';
    ...
    {
        $this->setIfExists('type', $data ?? [], 'content_block_delta');
