...
class StoryUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string[] $display_image_urls display_image_urls
     *
     * @return self
     */
    public function setDisplayImageUrls($display_image_urls)
    {
        if (is_null($display_image_urls)) {
            array_push($this->openAPINullablesSetToNull, 'display_image_urls');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('display_image_urls', $nullablesSetToNull);
            if ($index !== FALSE) {
