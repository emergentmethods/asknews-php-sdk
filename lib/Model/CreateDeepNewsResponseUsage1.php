...
/**
 * CreateDeepNewsResponseUsage1 Class Doc Comment
 *
 * @category Class
 * @package  AskNews
 * @author   OpenAPI Generator team
 ...
 */
class CreateDeepNewsResponseUsage1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateDeepNewsResponseUsage_1';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('tool_usage', $data ?? [], null);
    }
    ...
    */
     ...
     */
    public function getToolUsage()
    {
        return $this->container['tool_usage'];
    }

    /**
     * Sets tool_usage
     *
     * @param array<string,int>|null $tool_usage tool_usage
     *
     * @return self
     */
    public function setToolUsage($tool_usage)
    {
        if (is_null($tool_usage)) {
            array_push($this->openAPINullablesSetToNull, 'tool_usage');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('tool_usage', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['tool_usage'] = $tool_usage;
