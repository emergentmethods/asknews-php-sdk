...
/**
 * BlueskySource Class Doc Comment
 *
 * @category Class
 * @package  AskNews
 * @author   OpenAPI Generator team
 ...
 */
class BlueskySource implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BlueskySource';
    ...
    protected static $openAPITypes = [
        'identifier' => 'string',
        'params' => '\AskNews\Model\BlueskySourceParams'
    ];
    ...
    public const IDENTIFIER_BLUESKY = 'bluesky';
    ...
    {
        $this->setIfExists('identifier', $data ?? [], 'bluesky');
    ...
    */
     ...
     * Gets params
     *
     * @return \AskNews\Model\BlueskySourceParams|null
     */
     ...
     * Sets params
     *
     * @param \AskNews\Model\BlueskySourceParams|null $params params
     *
     * @return self
     */
