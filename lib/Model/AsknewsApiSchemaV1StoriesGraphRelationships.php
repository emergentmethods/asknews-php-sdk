...
/**
 * AsknewsApiSchemaV1StoriesGraphRelationships Class Doc Comment
 *
 * @category Class
 * @package  AskNews
 * @author   OpenAPI Generator team
 ...
 */
class AsknewsApiSchemaV1StoriesGraphRelationships implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'asknews_api__schema__v1__stories__GraphRelationships';
    ...
    */
     ...
     * Sets nodes
     *
     * @param array<string,string>[] $nodes nodes
     *
     * @return self
     */
     ...
     * Sets edges
     *
     * @param array<string,string>[] $edges edges
     *
     * @return self
     */
