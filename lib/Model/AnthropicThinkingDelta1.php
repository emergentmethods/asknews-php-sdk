...
/**
 * AnthropicThinkingDelta1 Class Doc Comment
 *
 * @category Class
 * @package  AskNews
 * @author   OpenAPI Generator team
 ...
 */
class AnthropicThinkingDelta1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AnthropicThinkingDelta_1';
    ...
    {
        $this->setIfExists('type', $data ?? [], 'thinking_delta');
