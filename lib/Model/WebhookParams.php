 ...
 */
class WebhookParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WebhookParams';
    ...
    */
     ...
     * Sets url
     *
     * @param string $url The URL to send the webhook when the alert triggers
     *
     * @return self
     */
    public function setUrl($url)
    {
        ...
        if ((mb_strlen($url) > 2083)) {
            throw new \InvalidArgumentException('invalid length for $url when calling WebhookParams., must be smaller than or equal to 2083.');
        }
        if ((mb_strlen($url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $url when calling WebhookParams., must be bigger than or equal to 1.');
        }
