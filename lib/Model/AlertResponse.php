...
class AlertResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets sources
     *
     * @param array<string,mixed>[]|null $sources sources
     *
     * @return self
     */
     ...
     * Gets report
     *
     * @return \AskNews\Model\Report|null
     */
     ...
     * Sets report
     *
     * @param \AskNews\Model\Report|null $report report
     *
     * @return self
     */
     ...
     * Sets seat_id
     *
     * @param string|null $seat_id seat_id
     *
     * @return self
     */
    ...
    {
        if (is_null($seat_id)) {
            array_push($this->openAPINullablesSetToNull, 'seat_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('seat_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
