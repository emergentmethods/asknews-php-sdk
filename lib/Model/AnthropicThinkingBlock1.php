...
/**
 * AnthropicThinkingBlock1 Class Doc Comment
 *
 * @category Class
 * @package  AskNews
 * @author   OpenAPI Generator team
 ...
 */
class AnthropicThinkingBlock1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AnthropicThinkingBlock_1';
    ...
    {
        $this->setIfExists('type', $data ?? [], 'thinking');
        $this->setIfExists('thinking', $data ?? [], '');
    }
    ...
    */
     ...
     * Sets thinking
     *
     * @param string|null $thinking thinking
     *
     * @return self
     */
