...
/**
 * AskNewsSource Class Doc Comment
 *
 * @category Class
 * @package  AskNews
 * @author   OpenAPI Generator team
 ...
 */
class AskNewsSource implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AskNewsSource';
    ...
    protected static $openAPITypes = [
        'identifier' => 'string',
        'params' => '\AskNews\Model\FilterParams'
    ];
    ...
    public const IDENTIFIER_ASKNEWS = 'asknews';
    ...
    {
        $this->setIfExists('identifier', $data ?? [], 'asknews');
    ...
    */
     ...
     * Sets params
     *
     * @param \AskNews\Model\FilterParams|null $params params
     *
     * @return self
     */
