...
/**
 * TopNArticlesTimeseriesItem Class Doc Comment
 *
 * @category Class
 * @package  AskNews
 * @author   OpenAPI Generator team
 ...
 */
class TopNArticlesTimeseriesItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TopNArticlesTimeseriesItem';
    ...
    */
    ...
    public function setArticleId($article_id)
    {
        if (is_null($article_id)) {
            array_push($this->openAPINullablesSetToNull, 'article_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('article_id', $nullablesSetToNull);
            if ($index !== FALSE) {
