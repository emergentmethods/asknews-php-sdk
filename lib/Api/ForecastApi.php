...
class ForecastApi
{
     ...
     */
    public function getForecast($query, $lookback = 14, $articles_to_use = 15, $method = 'kw', $model = 'claude-3-5-sonnet-20240620', $cutoff_date = null, $use_reddit = false, $additional_context = null, $web_search = false, $expert = 'general', string $contentType = self::contentTypes['getForecast'][0])
    {
     ...
     */
    public function getForecastWithHttpInfo($query, $lookback = 14, $articles_to_use = 15, $method = 'kw', $model = 'claude-3-5-sonnet-20240620', $cutoff_date = null, $use_reddit = false, $additional_context = null, $web_search = false, $expert = 'general', string $contentType = self::contentTypes['getForecast'][0])
    {
     ...
     */
    public function getForecastAsync($query, $lookback = 14, $articles_to_use = 15, $method = 'kw', $model = 'claude-3-5-sonnet-20240620', $cutoff_date = null, $use_reddit = false, $additional_context = null, $web_search = false, $expert = 'general', string $contentType = self::contentTypes['getForecast'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getForecastAsyncWithHttpInfo($query, $lookback = 14, $articles_to_use = 15, $method = 'kw', $model = 'claude-3-5-sonnet-20240620', $cutoff_date = null, $use_reddit = false, $additional_context = null, $web_search = false, $expert = 'general', string $contentType = self::contentTypes['getForecast'][0])
    {
        $returnType = '\AskNews\Model\ForecastResponse';
        $request = $this->getForecastRequest($query, $lookback, $articles_to_use, $method, $model, $cutoff_date, $use_reddit, $additional_context, $web_search, $expert, $contentType);
     ...
     */
    public function getForecastRequest($query, $lookback = 14, $articles_to_use = 15, $method = 'kw', $model = 'claude-3-5-sonnet-20240620', $cutoff_date = null, $use_reddit = false, $additional_context = null, $web_search = false, $expert = 'general', string $contentType = self::contentTypes['getForecast'][0])
    {
