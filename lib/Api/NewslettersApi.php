...
class NewslettersApi
{
     ...
     * @throws \AskNews\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \AskNews\Model\PaginatedResponseNewsletterResponse
     */
     ...
     * @throws \AskNews\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \AskNews\Model\PaginatedResponseNewsletterResponse, HTTP status code, HTTP response headers (array of strings)
     */
