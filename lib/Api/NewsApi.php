...
class NewsApi
{
     ...
     * @return \AskNews\Model\SearchResponseDictItem|\AskNews\Model\ValidationErrorModel|\AskNews\Model\AbcAPIErrorModel17|\AskNews\Model\AbcAPIErrorModel18|\AskNews\Model\AbcAPIErrorModel19|\AskNews\Model\AbcAPIErrorModel20|\AskNews\Model\AsknewsApiErrorsAPIErrorModel
     */
     ...
     * @param  bool $full_text Whether to return the full text of the articles. (optional, default to false)
     ...
     */
    public function getArticles($article_ids, $full_text = false, string $contentType = self::contentTypes['getArticles'][0])
    {
        list($response) = $this->getArticlesWithHttpInfo($article_ids, $full_text, $contentType);
        return $response;
    }
     ...
     */
    public function getArticlesWithHttpInfo($article_ids, $full_text = false, string $contentType = self::contentTypes['getArticles'][0])
    {
        $request = $this->getArticlesRequest($article_ids, $full_text, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getArticlesAsync($article_ids, $full_text = false, string $contentType = self::contentTypes['getArticles'][0])
    {
        return $this->getArticlesAsyncWithHttpInfo($article_ids, $full_text, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getArticlesAsyncWithHttpInfo($article_ids, $full_text = false, string $contentType = self::contentTypes['getArticles'][0])
    {
        $returnType = '\AskNews\Model\SearchResponseDictItem[]';
        $request = $this->getArticlesRequest($article_ids, $full_text, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getArticlesRequest($article_ids, $full_text = false, string $contentType = self::contentTypes['getArticles'][0])
    {
    ...
    /**
     * Operation getIndexCounts
     *
     * Get the index counts underlying AskNews
     *
     * @param  \DateTime $start_datetime Start timestamp to filter by (optional)
     * @param  \DateTime $end_datetime End timestamp to filter by (optional)
     * @param  string[] $domains Domain or list of domains to get indexing counts for (optional)
     * @param  string $sampling Sampling to use (optional, default to '1d')
     * @param  string $time_filter Control which date type to filter on. &#39;crawl_date&#39; is the date the article was crawled, &#39;pub_date&#39; is the date the article was published. (optional, default to 'pub_date')
     * @param  string[] $categories Categories of news to filter on (optional)
     * @param  string $provocative Filter articles based on how provocative they are deemed based on the use of provocative language and emotional vocabulary. (optional)
     * @param  string[] $reporting_voice Type of reporting voice to filer by. (optional)
     * @param  \AskNews\Model\BadDomainUrl1 $bad_domain_url blacklist of domains that must be excluded from resultsThis can be a single domain url or a list of domain urls. (optional)
     * @param  int $page_rank maximum allowed pagerank for returned articles (optional)
     * @param  string[] $string_guarantee If defined, the search will only occur on articles that contain this string. (optional)
     * @param  string $string_guarantee_op Operator to use for string guarantee. (optional, default to 'AND')
     * @param  string[] $reverse_string_guarantee If defined, the search will only occur on articles that do not contain this string. (optional)
     ...
     * @param  string $entity_guarantee_op Operator to use for entity guarantee. (optional, default to 'OR')
     ...
     * @param  string[] $countries Source countries to filter by (this is only for the publisher location, not the locations mentioned in articles. For Locations mentioned in articles, refer to entity_guarantee), countries must be the two-letter ISO country codeFor example: United States is &#39;US&#39;, France is &#39;FR&#39;, Sweden is &#39;SE&#39;. (optional)
     * @param  string[] $countries_blacklist Source countries to blacklist from search (this is only for the publisher location, not the locations mentioned in articles. For Locations mentioned in articles, refer to reverse_entity_guarantee), countries must be the two-letter ISO country codeFor example: United States is &#39;US&#39;, France is &#39;FR&#39;, Sweden is &#39;SE&#39;. (optional)
     * @param  string[] $continents Continents to filter by (optional)
     * @param  string $sentiment Sentiment to filter news articles by. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getIndexCounts'] to see the possible values for this operation
     *
     * @throws \AskNews\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \AskNews\Model\IndexCountItem[]|\AskNews\Model\ValidationErrorModel|\AskNews\Model\AbcAPIErrorModel25|\AskNews\Model\AbcAPIErrorModel26|\AskNews\Model\AbcAPIErrorModel27|\AskNews\Model\AbcAPIErrorModel28|\AskNews\Model\AsknewsApiErrorsAPIErrorModel
     */
    public function getIndexCounts($start_datetime = null, $end_datetime = null, $domains = null, $sampling = '1d', $time_filter = 'pub_date', $categories = null, $provocative = null, $reporting_voice = null, $bad_domain_url = null, $page_rank = null, $string_guarantee = null, $string_guarantee_op = 'AND', $reverse_string_guarantee = null, $entity_guarantee = null, $entity_guarantee_op = 'OR', $languages = null, $countries = null, $countries_blacklist = null, $continents = null, $sentiment = null, string $contentType = self::contentTypes['getIndexCounts'][0])
    {
        list($response) = $this->getIndexCountsWithHttpInfo($start_datetime, $end_datetime, $domains, $sampling, $time_filter, $categories, $provocative, $reporting_voice, $bad_domain_url, $page_rank, $string_guarantee, $string_guarantee_op, $reverse_string_guarantee, $entity_guarantee, $entity_guarantee_op, $languages, $countries, $countries_blacklist, $continents, $sentiment, $contentType);
        return $response;
    }

    /**
     * Operation getIndexCountsWithHttpInfo
     *
     * Get the index counts underlying AskNews
     *
     * @param  \DateTime $start_datetime Start timestamp to filter by (optional)
     ...
     * @throws \AskNews\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \AskNews\Model\IndexCountItem[]|\AskNews\Model\ValidationErrorModel|\AskNews\Model\AbcAPIErrorModel25|\AskNews\Model\AbcAPIErrorModel26|\AskNews\Model\AbcAPIErrorModel27|\AskNews\Model\AbcAPIErrorModel28|\AskNews\Model\AsknewsApiErrorsAPIErrorModel, HTTP status code, HTTP response headers (array of strings)
     */
    public function getIndexCountsWithHttpInfo($start_datetime = null, $end_datetime = null, $domains = null, $sampling = '1d', $time_filter = 'pub_date', $categories = null, $provocative = null, $reporting_voice = null, $bad_domain_url = null, $page_rank = null, $string_guarantee = null, $string_guarantee_op = 'AND', $reverse_string_guarantee = null, $entity_guarantee = null, $entity_guarantee_op = 'OR', $languages = null, $countries = null, $countries_blacklist = null, $continents = null, $sentiment = null, string $contentType = self::contentTypes['getIndexCounts'][0])
    {
        $request = $this->getIndexCountsRequest($start_datetime, $end_datetime, $domains, $sampling, $time_filter, $categories, $provocative, $reporting_voice, $bad_domain_url, $page_rank, $string_guarantee, $string_guarantee_op, $reverse_string_guarantee, $entity_guarantee, $entity_guarantee_op, $languages, $countries, $countries_blacklist, $continents, $sentiment, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\AskNews\Model\IndexCountItem[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\AskNews\Model\IndexCountItem[]' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\AskNews\Model\IndexCountItem[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 422:
            ...
            $returnType = '\AskNews\Model\IndexCountItem[]';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getIndexCountsAsync($start_datetime = null, $end_datetime = null, $domains = null, $sampling = '1d', $time_filter = 'pub_date', $categories = null, $provocative = null, $reporting_voice = null, $bad_domain_url = null, $page_rank = null, $string_guarantee = null, $string_guarantee_op = 'AND', $reverse_string_guarantee = null, $entity_guarantee = null, $entity_guarantee_op = 'OR', $languages = null, $countries = null, $countries_blacklist = null, $continents = null, $sentiment = null, string $contentType = self::contentTypes['getIndexCounts'][0])
    {
        return $this->getIndexCountsAsyncWithHttpInfo($start_datetime, $end_datetime, $domains, $sampling, $time_filter, $categories, $provocative, $reporting_voice, $bad_domain_url, $page_rank, $string_guarantee, $string_guarantee_op, $reverse_string_guarantee, $entity_guarantee, $entity_guarantee_op, $languages, $countries, $countries_blacklist, $continents, $sentiment, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getIndexCountsAsyncWithHttpInfo
     *
     * Get the index counts underlying AskNews
     *
     * @param  \DateTime $start_datetime Start timestamp to filter by (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getIndexCountsAsyncWithHttpInfo($start_datetime = null, $end_datetime = null, $domains = null, $sampling = '1d', $time_filter = 'pub_date', $categories = null, $provocative = null, $reporting_voice = null, $bad_domain_url = null, $page_rank = null, $string_guarantee = null, $string_guarantee_op = 'AND', $reverse_string_guarantee = null, $entity_guarantee = null, $entity_guarantee_op = 'OR', $languages = null, $countries = null, $countries_blacklist = null, $continents = null, $sentiment = null, string $contentType = self::contentTypes['getIndexCounts'][0])
    {
        $returnType = '\AskNews\Model\IndexCountItem[]';
        $request = $this->getIndexCountsRequest($start_datetime, $end_datetime, $domains, $sampling, $time_filter, $categories, $provocative, $reporting_voice, $bad_domain_url, $page_rank, $string_guarantee, $string_guarantee_op, $reverse_string_guarantee, $entity_guarantee, $entity_guarantee_op, $languages, $countries, $countries_blacklist, $continents, $sentiment, $contentType);
    ...
    /**
     * Create request for operation 'getIndexCounts'
     *
     * @param  \DateTime $start_datetime Start timestamp to filter by (optional)
     * @param  \DateTime $end_datetime End timestamp to filter by (optional)
     * @param  string[] $domains Domain or list of domains to get indexing counts for (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getIndexCountsRequest($start_datetime = null, $end_datetime = null, $domains = null, $sampling = '1d', $time_filter = 'pub_date', $categories = null, $provocative = null, $reporting_voice = null, $bad_domain_url = null, $page_rank = null, $string_guarantee = null, $string_guarantee_op = 'AND', $reverse_string_guarantee = null, $entity_guarantee = null, $entity_guarantee_op = 'OR', $languages = null, $countries = null, $countries_blacklist = null, $continents = null, $sentiment = null, string $contentType = self::contentTypes['getIndexCounts'][0])
    {
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $start_datetime,
            'start_datetime', // param base name
            'string', // openApiType
            'form', // style
            true, // explode
            false // required
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $bad_domain_url,
            'bad_domain_url', // param base name
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $countries_blacklist,
            'countries_blacklist', // param base name
            'array', // openApiType
            'form', // style
            true, // explode
            false // required
     ...
     * @throws \AskNews\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \AskNews\Model\SourceReportItem[]|\AskNews\Model\ValidationErrorModel|\AskNews\Model\AbcAPIErrorModel21|\AskNews\Model\AbcAPIErrorModel22|\AskNews\Model\AbcAPIErrorModel23|\AskNews\Model\AbcAPIErrorModel24|\AskNews\Model\AsknewsApiErrorsAPIErrorModel
     */
     ...
     * @param  \AskNews\Model\Offset $offset Offset for pagination. The n_articles is your page size, while your offset is the number of articles to skip to get to your page of interest. For example, if you want to get page 3 for n_article page size of 10, you would set offset to 20. (optional)
     * @param  string[] $categories Categories of news to filter on (optional)
     ...
     * @param  string $provocative Filter articles based on how provocative they are deemed based on the use of provocative language and emotional vocabulary. (optional)
     * @param  \AskNews\Model\ReportingVoice $reporting_voice Type of reporting voice to filer by. (optional)
     * @param  \AskNews\Model\DomainUrl $domain_url filter by domain url of interest. This can be a single domain or a list of domains. For example, &#39;npr.org&#39; or [&#39;nature.com&#39;, &#39;npr.org&#39;] (optional)
     * @param  \AskNews\Model\BadDomainUrl $bad_domain_url blacklist of domains that must be excluded from resultsThis can be a single domain url or a list of domain urls. (optional)
     * @param  string $podcasts Control whether podcasts are included in search results. &#39;include&#39; searches news and podcasts, &#39;only&#39; searches podcasts only, and &#39;none&#39; excludes podcasts. (optional, default to 'include')
     ...
     * @param  string[] $authors Authors to filter articles by. (optional)
     * @param  string $try_cache Enable response caching with the specified TTL. When a cached response is returned, usage is charged at 0.25x the normal rate. Valid values: &#39;1h&#39; (1 hour), &#39;6h&#39; (6 hours), &#39;12h&#39; (12 hours), &#39;24h&#39; (24 hours), &#39;3d&#39; (3 days), &#39;7d&#39; (7 days). (optional)
     * @param  float $geo_lat Latitude for geo-radius filter. Must be provided together with geo_lon and geo_radius. Filters articles whose coordinates fall within the specified circle. (optional)
     * @param  float $geo_lon Longitude for geo-radius filter. Must be provided together with geo_lat and geo_radius. (optional)
     * @param  float $geo_radius Radius in meters for geo-radius filter. Must be provided together with geo_lat and geo_lon. (optional)
     * @param  string $geo_polygon JSON string defining a polygon for geo filtering. Must contain an &#39;exterior&#39; key with a list of {lon, lat} points. The first and last point must be the same. Optionally include &#39;interiors&#39; as a list of rings (each a list of {lon, lat} points) to exclude areas. Example: {\&quot;exterior\&quot;: [{\&quot;lon\&quot;: -70, \&quot;lat\&quot;: -70}, {\&quot;lon\&quot;: 60, \&quot;lat\&quot;: -70}, {\&quot;lon\&quot;: 60, \&quot;lat\&quot;: 60}, {\&quot;lon\&quot;: -70, \&quot;lat\&quot;: 60}, {\&quot;lon\&quot;: -70, \&quot;lat\&quot;: -70}]} (optional)
    ...
    public function searchNewsRequest($query = '', $n_articles = 10, $start_timestamp = null, $end_timestamp = null, $time_filter = 'crawl_date', $return_type = 'dicts', $historical = false, $method = 'kw', $similarity_score_threshold = 0.5, $offset = null, $categories = null, $doc_start_delimiter = '<doc>', $doc_end_delimiter = '</doc>', $provocative = null, $reporting_voice = null, $domain_url = null, $bad_domain_url = null, $podcasts = 'include', $page_rank = null, $diversify_sources = false, $strategy = 'default', $hours_back = 24, $string_guarantee = null, $string_guarantee_op = 'AND', $reverse_string_guarantee = null, $entity_guarantee = null, $reverse_entity_guarantee = null, $entity_guarantee_op = 'OR', $return_graphs = false, $return_geo = false, $languages = null, $countries = null, $countries_blacklist = null, $continents = null, $sentiment = null, $premium = false, $authors = null, $try_cache = null, $geo_lat = null, $geo_lon = null, $geo_radius = null, $geo_polygon = null, string $contentType = self::contentTypes['searchNews'][0])
    {
        ...
        if ($n_articles !== null && $n_articles > 101) {
            throw new \InvalidArgumentException('invalid value for "$n_articles" when calling NewsApi.searchNews, must be smaller than or equal to 101.');
        }
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            ...
            'anyOf&lt;integer,UUID&gt;', // openApiType
            'form', // style
            true, // explode
            false // required
        ) ?? []);
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            ...
            'reverse_entity_guarantee', // param base name
            'array', // openApiType
            'form', // style
            true, // explode
            false // required
