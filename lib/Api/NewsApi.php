...
class NewsApi
{
     ...
     * @param  BadDomainUrl $bad_domain_url blacklist of domains that must be excluded from resultsThis can be a single domain url or a list of domain urls. (optional)
