...
class NewsApi
{
     ...
     *
     * @param  \DateTime $start_datetime Start timestamp to filter by (required)
     * @param  \DateTime $end_datetime End timestamp to filter by (required)
     ...
     * @throws \AskNews\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \AskNews\Model\IndexCountItem[]|\AskNews\Model\ValidationErrorModel|\AskNews\Model\AbcAPIErrorModel21|\AskNews\Model\AbcAPIErrorModel22|\AskNews\Model\AbcAPIErrorModel23|\AskNews\Model\AbcAPIErrorModel24|\AskNews\Model\AsknewsApiErrorsAPIErrorModel
     */
    public function getIndexCounts($start_datetime, $end_datetime, $domains = null, $sampling = '1d', $time_filter = 'pub_date', $categories = null, $provocative = null, $reporting_voice = null, $bad_domain_url = null, $page_rank = null, $string_guarantee = null, $string_guarantee_op = 'AND', $reverse_string_guarantee = null, $entity_guarantee = null, $entity_guarantee_op = 'OR', $languages = null, $countries = null, $countries_blacklist = null, $continents = null, $sentiment = null, string $contentType = self::contentTypes['getIndexCounts'][0])
    {
     ...
     */
    public function getIndexCountsWithHttpInfo($start_datetime, $end_datetime, $domains = null, $sampling = '1d', $time_filter = 'pub_date', $categories = null, $provocative = null, $reporting_voice = null, $bad_domain_url = null, $page_rank = null, $string_guarantee = null, $string_guarantee_op = 'AND', $reverse_string_guarantee = null, $entity_guarantee = null, $entity_guarantee_op = 'OR', $languages = null, $countries = null, $countries_blacklist = null, $continents = null, $sentiment = null, string $contentType = self::contentTypes['getIndexCounts'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getIndexCountsAsync($start_datetime, $end_datetime, $domains = null, $sampling = '1d', $time_filter = 'pub_date', $categories = null, $provocative = null, $reporting_voice = null, $bad_domain_url = null, $page_rank = null, $string_guarantee = null, $string_guarantee_op = 'AND', $reverse_string_guarantee = null, $entity_guarantee = null, $entity_guarantee_op = 'OR', $languages = null, $countries = null, $countries_blacklist = null, $continents = null, $sentiment = null, string $contentType = self::contentTypes['getIndexCounts'][0])
    {
    ...
    public function getIndexCountsRequest($start_datetime, $end_datetime, $domains = null, $sampling = '1d', $time_filter = 'pub_date', $categories = null, $provocative = null, $reporting_voice = null, $bad_domain_url = null, $page_rank = null, $string_guarantee = null, $string_guarantee_op = 'AND', $reverse_string_guarantee = null, $entity_guarantee = null, $entity_guarantee_op = 'OR', $languages = null, $countries = null, $countries_blacklist = null, $continents = null, $sentiment = null, string $contentType = self::contentTypes['getIndexCounts'][0])
    {
        ...
        if ($start_datetime === null || (is_array($start_datetime) && count($start_datetime) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $start_datetime when calling getIndexCounts'
            );
        }
        ...
        if ($end_datetime === null || (is_array($end_datetime) && count($end_datetime) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $end_datetime when calling getIndexCounts'
            );
        }
