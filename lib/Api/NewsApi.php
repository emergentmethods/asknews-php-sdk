...
class NewsApi
{
     ...
     * @return \AskNews\Model\SearchResponseDictItem|\AskNews\Model\ValidationErrorModel|\AskNews\Model\AbcAPIErrorModel5|\AskNews\Model\AbcAPIErrorModel6|\AskNews\Model\AbcAPIErrorModel7|\AskNews\Model\AbcAPIErrorModel8|\AskNews\Model\AsknewsApiErrorsAPIErrorModel
     */
     ...
     * @throws \AskNews\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \AskNews\Model\SourceReportItem[]|\AskNews\Model\ValidationErrorModel|\AskNews\Model\AbcAPIErrorModel9|\AskNews\Model\AbcAPIErrorModel10|\AskNews\Model\AbcAPIErrorModel11|\AskNews\Model\AbcAPIErrorModel12|\AskNews\Model\AsknewsApiErrorsAPIErrorModel
     */
     ...
     *
     * @param  string $query Query string that can be any phrase, keyword, question, or paragraph. If method&#x3D;&#39;nl&#39;, then this will be used as a natural language query. If method&#x3D;&#39;kw&#39;, then this will be used as a direct keyword query. (required)
     ...
     * @param  int $offset Offset for pagination. The n_articles is your page size, while your offset is the number of articles to skip to get to your page of interest. For example, if you want to get page 3 for n_article page size of 10, you would set offset to 20. (optional, default to 0)
     ...
     * @param  string $reporting_voice Type of reporting voice to filer by. (optional, default to 'all')
     * @param  string $domain_url filter by domain url of interest. (optional)
    ...
    public function searchNewsRequest($query, $n_articles = 10, $start_timestamp = null, $end_timestamp = null, $return_type = 'dicts', $historical = false, $method = 'nl', $similarity_score_threshold = 0.5, $offset = 0, $categories = null, $doc_start_delimiter = '<doc>', $doc_end_delimiter = '</doc>', $provocative = 'all', $reporting_voice = 'all', $domain_url = null, $page_rank = null, $diversify_sources = false, $strategy = 'default', $hours_back = 24, $string_guarantee = null, $reverse_string_guarantee = null, $entity_guarantee = null, $return_graphs = false, $languages = null, $countries = null, $continents = null, string $contentType = self::contentTypes['searchNews'][0])
    {
        ...
        if ($query === null || (is_array($query) && count($query) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $query when calling searchNews'
            );
        }
