...
class NewsApi
{
     ...
     *
     * @param  string[] $domains Domain or list of domains to get indexing counts for (required)
     ...
     */
    public function getIndexCounts($domains, $start_datetime = null, $end_datetime = null, $sampling = '1h', string $contentType = self::contentTypes['getIndexCounts'][0])
    {
        list($response) = $this->getIndexCountsWithHttpInfo($domains, $start_datetime, $end_datetime, $sampling, $contentType);
        return $response;
    }
     ...
     */
    public function getIndexCountsWithHttpInfo($domains, $start_datetime = null, $end_datetime = null, $sampling = '1h', string $contentType = self::contentTypes['getIndexCounts'][0])
    {
        $request = $this->getIndexCountsRequest($domains, $start_datetime, $end_datetime, $sampling, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getIndexCountsAsync($domains, $start_datetime = null, $end_datetime = null, $sampling = '1h', string $contentType = self::contentTypes['getIndexCounts'][0])
    {
        return $this->getIndexCountsAsyncWithHttpInfo($domains, $start_datetime, $end_datetime, $sampling, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getIndexCountsAsyncWithHttpInfo($domains, $start_datetime = null, $end_datetime = null, $sampling = '1h', string $contentType = self::contentTypes['getIndexCounts'][0])
    {
        $returnType = '\AskNews\Model\IndexCountItem[]';
        $request = $this->getIndexCountsRequest($domains, $start_datetime, $end_datetime, $sampling, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getIndexCountsRequest($domains, $start_datetime = null, $end_datetime = null, $sampling = '1h', string $contentType = self::contentTypes['getIndexCounts'][0])
    {

        // verify the required parameter 'domains' is set
        if ($domains === null || (is_array($domains) && count($domains) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $domains when calling getIndexCounts'
            );
        }
