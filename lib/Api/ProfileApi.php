...
class ProfileApi
{
     ...
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getRateLimitStatus'] to see the possible values for this operation
     *
     * @throws \AskNews\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \AskNews\Model\RateLimitStatusResponse|\AskNews\Model\ValidationErrorModel|\AskNews\Model\AbcAPIErrorModel53|\AskNews\Model\AbcAPIErrorModel54|\AskNews\Model\AbcAPIErrorModel55|\AskNews\Model\AbcAPIErrorModel56|\AskNews\Model\AsknewsApiErrorsAPIErrorModel
     */
    public function getRateLimitStatus(string $contentType = self::contentTypes['getRateLimitStatus'][0])
    {
        list($response) = $this->getRateLimitStatusWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation getRateLimitStatusWithHttpInfo
     *
     * Get the current user&#39;s rate limit status
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getRateLimitStatus'] to see the possible values for this operation
    ...
    public function getRateLimitStatusWithHttpInfo(string $contentType = self::contentTypes['getRateLimitStatus'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\AskNews\Model\RateLimitStatusResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\AskNews\Model\RateLimitStatusResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\AskNews\Model\RateLimitStatusResponse', []),
            ...
            $returnType = '\AskNews\Model\RateLimitStatusResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\AskNews\Model\RateLimitStatusResponse',
    ...
    /**
     * Operation getRateLimitStatusAsync
     *
     * Get the current user&#39;s rate limit status
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getRateLimitStatus'] to see the possible values for this operation
     ...
     */
    public function getRateLimitStatusAsync(string $contentType = self::contentTypes['getRateLimitStatus'][0])
    {
        return $this->getRateLimitStatusAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getRateLimitStatusAsyncWithHttpInfo
     *
     * Get the current user&#39;s rate limit status
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getRateLimitStatus'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getRateLimitStatusAsyncWithHttpInfo(string $contentType = self::contentTypes['getRateLimitStatus'][0])
    {
        $returnType = '\AskNews\Model\RateLimitStatusResponse';
        $request = $this->getRateLimitStatusRequest($contentType);
    ...
    /**
     * Create request for operation 'getRateLimitStatus'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getRateLimitStatus'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     ...
     */
    public function getRateLimitStatusRequest(string $contentType = self::contentTypes['getRateLimitStatus'][0])
    {


        $resourcePath = '/v1/profiles/me/limits';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \AskNews\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \AskNews\Model\ProfileResponse|\AskNews\Model\ValidationErrorModel|\AskNews\Model\AbcAPIErrorModel49|\AskNews\Model\AbcAPIErrorModel50|\AskNews\Model\AbcAPIErrorModel51|\AskNews\Model\AbcAPIErrorModel52|\AskNews\Model\AsknewsApiErrorsAPIErrorModel
     */
